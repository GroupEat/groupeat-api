...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Available Mailing locales
    |--------------------------------------------------------------------------
    |
    | The application can send e-mails with the following languages :
    |
    */

    'available_mailing_locales' => ['fr'],
    ...
    */
    ...
    'key' => env('APP_KEY', '0rhjhcJnDXSWaEKMgShrWHO2WGeAlty7'),
