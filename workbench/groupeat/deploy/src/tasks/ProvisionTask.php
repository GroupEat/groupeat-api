...
class ProvisionTask extends AbstractTask {
    ...
    {
        $username = $this->command->ask('Enter your GitHub username: ');
        $password = $this->command->askSecretly('Enter your GitHub password: ');
    ...
    {
        return $this->getFile('~vagrant/.ssh/id_rsa.pub');
    }
