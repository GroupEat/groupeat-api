@include('partials.vertical-space')
    ...
    <tr>
        <td width="600" valign="middle" align="center">
            <table border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter2">
                <tbody>
                <tr>
                    <td align="center" height="45" c-style="not6ButBG" bgcolor="#26b053" style="border-radius: 5px; padding-left: 30px; padding-right: 30px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; color: rgb(255, 255, 255); background-color: rgb(35, 175, 80);" t-style="not6ButText" mc:edit="42">
                        <multiline>
